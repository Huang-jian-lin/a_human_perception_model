...
def main():
    ...
    parser.add_argument('--checkpoint', default='checkpoints/depressing/depressing.pth', help='Checkpoint file')
    parser.add_argument('--save_result_path', default='category_probability_info_file/depressing_category_probability_info.txt', help='Path used to save result')
    ...
    # modify the config
    # Path for dataset
    cfg.data.train.data_prefix = 'data/depressing/train'
    cfg.data.train.classes = 'data/depressing/classes.txt'

    cfg.data.val.data_prefix = 'data/depressing/val'
    cfg.data.val.ann_file = 'data/depressing/val.txt'
    cfg.data.val.classes = 'data/depressing/classes.txt'

    cfg.data.test.data_prefix = 'data/depressing/test'
    cfg.data.test.ann_file = 'data/depressing/test.txt'
    cfg.data.test.classes = 'data/depressing/classes.txt'
    ...
    cfg.work_dir = 'work_dirs/depressing_dataset_10e'
    cfg.seed = 0
