...
def main():
    ...
    parser.add_argument('--checkpoint', default='checkpoints/wealthy/wealthy.pth', help='Checkpoint file')
    parser.add_argument('--save_result_path', default='category_probability_info_file/wealthy_category_probability_info.txt', help='Path used to save result')
    ...
    # modify the config
    # Path for dataset
    cfg.data.train.data_prefix = 'data/wealthy/train'
    cfg.data.train.classes = 'data/wealthy/classes.txt'

    cfg.data.val.data_prefix = 'data/wealthy/val'
    cfg.data.val.ann_file = 'data/wealthy/val.txt'
    cfg.data.val.classes = 'data/wealthy/classes.txt'

    cfg.data.test.data_prefix = 'data/wealthy/test'
    cfg.data.test.ann_file = 'data/wealthy/test.txt'
    cfg.data.test.classes = 'data/wealthy/classes.txt'
    ...
    cfg.work_dir = 'work_dirs/wealthy_dataset_10e'
    cfg.seed = 0
