...
def main():
    ...
    parser.add_argument('--checkpoint', default='checkpoints/lively/lively.pth', help='Checkpoint file')
    parser.add_argument('--save_result_path', default='category_probability_info_file/lively_category_probability_info.txt', help='Path used to save result')
    ...
    # modify the config
    # Path for dataset
    cfg.data.train.data_prefix = 'data/lively/train'
    cfg.data.train.classes = 'data/lively/classes.txt'

    cfg.data.val.data_prefix = 'data/lively/val'
    cfg.data.val.ann_file = 'data/lively/val.txt'
    cfg.data.val.classes = 'data/lively/classes.txt'

    cfg.data.test.data_prefix = 'data/lively/test'
    cfg.data.test.ann_file = 'data/lively/test.txt'
    cfg.data.test.classes = 'data/lively/classes.txt'
    ...
    cfg.work_dir = 'work_dirs/lively_dataset_10e'
    cfg.seed = 0
