...
def main():
    ...
    parser.add_argument('--checkpoint', default='checkpoints/beautiful/beautiful.pth', help='Checkpoint file')
    parser.add_argument('--save_result_path', default='category_probability_info_file/beautiful_category_probability_info.txt', help='Path used to save result')
    ...
    # modify the config
    # Path for dataset
    cfg.data.train.data_prefix = 'data/beautiful/train'
    cfg.data.train.classes = 'data/beautiful/classes.txt'

    cfg.data.val.data_prefix = 'data/beautiful/val'
    cfg.data.val.ann_file = 'data/beautiful/val.txt'
    cfg.data.val.classes = 'data/beautiful/classes.txt'

    cfg.data.test.data_prefix = 'data/beautiful/test'
    cfg.data.test.ann_file = 'data/beautiful/test.txt'
    cfg.data.test.classes = 'data/beautiful/classes.txt'
    ...
    cfg.work_dir = 'work_dirs/beautiful_dataset_10e'
    cfg.seed = 0
