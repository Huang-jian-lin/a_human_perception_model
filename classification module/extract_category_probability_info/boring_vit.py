...
def main():
    ...
    parser.add_argument('--checkpoint', default='checkpoints/boring/boring.pth', help='Checkpoint file')
    parser.add_argument('--save_result_path', default='category_probability_info_file/boring_category_probability_info.txt', help='Path used to save result')
    ...
    # modify the config
    # Path for dataset
    cfg.data.train.data_prefix = 'data/boring/train'
    cfg.data.train.classes = 'data/boring/classes.txt'

    cfg.data.val.data_prefix = 'data/boring/val'
    cfg.data.val.ann_file = 'data/boring/val.txt'
    cfg.data.val.classes = 'data/boring/classes.txt'

    cfg.data.test.data_prefix = 'data/boring/test'
    cfg.data.test.ann_file = 'data/boring/test.txt'
    cfg.data.test.classes = 'data/boring/classes.txt'
    ...
    cfg.work_dir = 'work_dirs/boring_dataset_10e'
    cfg.seed = 0
